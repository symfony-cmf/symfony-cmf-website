...
check(is_writable(__DIR__.'/../web/cache'), sprintf('Checking that cache/ directory is writable'), 'Change the permissions of the web/cache/ directory so that the web server can write in it', true);
check(is_writable(__DIR__.'/../web/logs'), sprintf('Checking that the logs/ directory is writable'), 'Change the permissions of the web/logs/ directory so that the web server can write in it', true);
